...
#ifndef JERRYX_ARGS_H
#define JERRYX_ARGS_H
 ...
 * - js_arg_iter_p : the JS argument iterator.
 * - c_arg_p : the current C argument
...
jerry_length_t jerryx_arg_js_iterator_get_index (jerryx_arg_js_iterator_t *js_arg_iter_p);
